    ...
    <div class="fixed w-64 left-0 top-0 bottom-0 border-r bg-black">
        ...
        <ol class="mt-8 w-full text-sm font-gotham">
            <li class="text-white text-opacity-75 mb-2 border-l-4 rounded-lg border-blue-500 border-opacity-0" :class="{
             ...
             <li class="text-white text-opacity-75 mb-2 border-l-4 rounded-lg border-red-500 border-opacity-0" :class="{
                 'bg-white bg-opacity-10 border-opacity-100 text-opacity-100 font-medium':
                     $route.name == 'dashboard',
             }">

                <router-link :to="{ name: 'dashboard' }" class="px-6 py-2 block">Users</router-link>
            </li>
            <!-- <li class="text-white text-opacity-75 mb-2 border-l-4 rounded-lg  border-blue-500 border-opacity-0" :class="{
                'bg-white bg-opacity-10 border-opacity-100 text-opacity-100 font-medium':
                    $route.name == '',
            ...
            <li>
                <a href="task" class="flex items-center p-2 text-base font-normal  rounded-lg text-gray-400 hover:bg-gray-100 ">
                    <svg aria-hidden="true"
